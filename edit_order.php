...
$sql3 = "SELECT customer_id FROM pre_orders WHERE id = $order_id";
$result3 = mysqli_query($connection, $sql3);
$result3 = $_SESSION['user_id'];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart'])) {
        ...
        echo "<script>alert('menu item added to cart!'); window.location.href = 'edit_order.php';</script>";
    }
    ?>
    ...
    <head>
        ...
        <title>The Gallery Café | Edit-Pre-Order</title>
    ...
    <body>
        ...
        <div id="srchBar">
            ...
            <a href="adminCart.php" id="link">View Cart</a>
            <a href="mng_orders.php" id="link">Back</a>
        </div>
